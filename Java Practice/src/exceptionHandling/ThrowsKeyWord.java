...
public class ThrowsKeyWord {
	...
	//used to handle the exception but we dont report anything
	...
	//The "throw" is used to throw an exception for a method
	...
	public void div() throws ArithmeticException{//exception line
		int i=9/0;
	}
